...
// Same list as app/free-guide/page.js — keep both in sync if this changes.
...
export default function Home() {
  return (
    <main>
        ...
        <div className="relative mx-auto max-w-wrap px-5 py-20 md:py-28">
          <div className="reveal max-w-2xl text-paper">
            ...
            <p className="mt-5 max-w-md font-body text-lg leading-relaxed text-paper/85">
              A new roof is a big purchase. We check licensing, insurance, and track record so
              you don&apos;t have to — then connect you with a roofer who actually works your
              suburb.
            </p>
      ...
      {/* ── EBOOK (5th) — full pitch, mirrors /free-guide ───── */}
